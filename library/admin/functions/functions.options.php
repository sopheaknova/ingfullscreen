...
$of_options[] = array( 	"name" 		=> "Call Label",
						"desc" 		=> "Support text and call number",
						"id" 		=> "call_label",
						"std" 		=> "Need some help?",
						"type" 		=> "text"
				);

$of_options[] = array( 	"name" 		=> "Call Number",
						"desc" 		=> "Support text and call number",
						"id" 		=> "call_number",
						"std" 		=> "Call us! +855 (0) 23 222 003",
						"type" 		=> "text"
				);
...
$of_options[] = array( 	"name" 		=> "Footer Text",
						"desc" 		=> "Copyright text",
						"id" 		=> "footer_text",
						"std" 		=> "ING HOLDING Co Ltd., © 2013 All Right Reserved.",
						"type" 		=> "textarea"
				);					
